        ...
        <div class="px-20 py-6">
          ...
          <div class="flex items-center justify-between">
            ...
            @if (Route::has('login'))
              ...
              <a href="{{ route('register') }}"><button class="px-6 py-3 rounded-3xl font-medium bg-gradient-to-b from-gray-900 to-black text-white outline-none focus:outline-none hover:shadow-md hover:from-true-gray-900 transition duration-200 ease-in-out">Sign Up</button></a>
              @endif
                    @endauth
                </div>
            @endif
