<x-app-layout>
	...
	<nav
		class="w-1/5 bg-white dark:bg-gray-800 select-none overflow-y-auto
		transition duration-500 ease-in-out">

		<div class="flex flex-col items-center ">
			
			<img
				class="h-16 w-16 rounded-full object-cover mt-4 mb-16"
		...
		<ul>
			<li
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">Property</span>
					</span>
				</button>
			</li>
			...
			<li
				...
				border-l-4 border-pink-500 hover:bg-pink-200 mb-2 transition
				duration-500 ease-in-out">
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">reservation<span class="bg-pink-500 p-1 rounded text-blue-600 text-xs ml-2">4</span></span>
					</span>
				</button>
			</li>
			...
			<li
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">room | Rates</span>
					</span>
				</button>
			</li>
			...
			<li
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">Photos</span>
					</span>
				</button>
			</li>
			...
			<li
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">Contacts</span>
					</span>
				</button>
			</li>
			...
			<li
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">Finance</span>
					</span>
				</button>
			</li>
			...
			<li
				...
				<button
					...
					<span class="flex items-center">
						...
						<span class="ml-4 capitalize">Collections</span>
					</span>
				</button>
			</li>
	...
	<main
		...
		<div
			...
			duration-500 ease-in-out">
			<h2 class="text-4xl font-medium capitalize">Rooms | Rates</h2>
					...
					<div
						...
						<div class="flex">
							...
							<div class="flex flex-col ml-6">
								<span class="text-lg font-bold">Standard Room</span>
								<div class="mt-4 flex">
									<div class="flex">
										<svg
